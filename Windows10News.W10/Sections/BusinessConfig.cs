...
{
    public class BusinessConfig : SectionConfigBase<RssSchema>
    {
		public override Func<Task<IEnumerable<RssSchema>>> LoadDataAsyncFunc
        {
            get
            {
                ...
                {
                    Url = new Uri("http://blogs.windows.com/business/feed/")
                };
        ...
        public override ListPageConfig<RssSchema> ListPage
        {
            get 
            {
                return new ListPageConfig<RssSchema>
                {
                    ...
                    ListNavigationInfo = NavigationInfo.FromPage("BusinessListPage"),
                    ...
                    {
                        return NavigationInfo.FromPage("BusinessDetailPage", true);
                    }
                };
            }
        }
