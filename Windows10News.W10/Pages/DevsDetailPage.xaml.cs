//---------------------------------------------------------------------------
//
// <copyright file="DevsDetailPage.xaml.cs" company="Microsoft">
...
{
    public sealed partial class DevsDetailPage : Page
    {
        private DataTransferManager _dataTransferManager;

        public DevsDetailPage()
        {
            this.ViewModel = DetailViewModel.CreateNew(Singleton<DevsConfig>.Instance);
